...
def model_main():
    ...
    parser.add_argument("--train_epochs", type=int, default=100, help="Number of training epochs")  # Training epochs
    parser.add_argument("--tune_epochs", type=int, default=100, help="Number of tuning epochs")  # Tuning epochs
    ...
    study.optimize(lambda trial: objective(trial, args.tune_epochs, device), n_trials=10)
